  ...
  return (
    ...
    >
      <div className="fixed right-0 top-0 h-screen bg-slate-100 pt-20 p-8 z-50 w-[250px]">
        ...
        <ul className="flex flex-col gap-3 text-xl text-gray-500">
          <li>
            <a href='#services' onClick={ () => setOpenMenu(false)}>Služby</a>
          </li>
          <li>
            <a href='#about-me'onClick={ () => setOpenMenu(false)}>Kdo jsme</a>
          </li>
          <li>
            <a href='#galery'onClick={ () => setOpenMenu(false)}>Galerie</a>
          </li>
          <li>
            <a href='#contact'onClick={ () => setOpenMenu(false)}>Kontakt</a>
          </li>
        </ul>
        <hr className="h-px my-8 bg-gray-500 border-0 "></hr>
        
        <ul className="flex gap-3 w-full items-center justify-between px-8 ">
            <a href="https://www.instagram.com/hairspace_praha/" target='_blank'>
            ...
            <a href="tel:+420776243789" target='_blank'>
