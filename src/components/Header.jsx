...
import logoHair from '../images/icons/logoHair.svg';
  ...
  return (
    <header className="sticky sticky-header top-0 z-20 p-2 mx-auto flex justify-between md:w-3/5 md:rounded-b-xl shadow-lg shadow-gray-500 bg-slate-50 transition-all ">
        <a className="logo md:w-1/3 flex items-center px-4 space-x-1" href='/'>
            <h1 className="text-gray-500 text-4xl  tracking-wider">Hairspace PRG</h1>
            <img src={logoHair.src} alt="hair logo" className="h-8 scale-125" />
        </a>
        <nav className="hidden md:flex  md:items-center md:text-center md:justify-center md:w-2/3 w-1/2 gap-4 ">
            <div className="flex items-center justify-end space-x-4 w-3/4 px-6">
                <a className="hover:scale-105" href="#services">Služby</a>   
                <a className="hover:scale-105" href="#about-me">Kdo jsme?</a>   
                <a className="hover:scale-105" href="#">Galerie</a>    
                <a className="hover:scale-105" href="#contact">Kontakt</a>  
            </div>
            <div className="flex justify-center md:gap-4 border-l-2 border-gray-500 items-center w-auto px-10">
                <a className="hover:scale-110" href="https://www.instagram.com/hairspace_praha/" target='_blank'>
                    <img src={nav_insta.src} alt="instagram" className="my-1" />    
                </a>    
                <a className="hover:scale-110" href="" target='_blank'>
                    <img src={nav_whatsapp.src}  alt="whatsapp" className="my-1" />    
                </a>    
                <a className="hover:scale-110" href="tel:+420776243789" target='_blank'>
